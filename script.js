const baseDeDados = [
    { titulo: "A Morte Pede Carona (2007)", capaID: "13hcPWKedhsuyKJjDnkA1OKsDBsqNQt9Q", videoID: "1Dv2kWhQBm1pp2QEWDmzgqQfK0Cs8bYlo", tipo: "filme", genero: "Terror", sinopse: "Uma viagem tranquila vira um pesadelo sangrento na estrada." },
    { titulo: "Cão de Briga (2005)", capaID: "1eQqmBbC-ynXoywSlftsWEn-AkTbDo6q0", videoID: "1S2ACOJIWCTT3iXqQZ91pl1-RLWxxZOuH", tipo: "filme", genero: "Ação", sinopse: "Um homem treinado para lutar descobre sua humanidade." },
...
function renderizarCard(item) {
    ...
    // SERVIDOR DE IMAGEM 5 É MAIS ESTÁVEL
