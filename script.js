const conteudos = [
    ...
    { titulo: "Ghostbusters: Apocalipse (2024)", capaID: "1OnhMByoRobT59CAlg7dKyUFNyuTRFmMq", videoID: "1vwFVDp4Dy9sDYt3IIE2FFNFlhxquke_3", tipo: "filme", genero: "Ficção" },
    ...
    // ROMANCE & SUSPENSE
    { titulo: "A Saga Crepúsculo: Amanhecer P1 (2011)", capaID: "1Dh-Rr4GX0SF775MM1nwXjY8HP7fmoWeK", videoID: "1ja1P_ckNanuacbCZEb3AdtKygfB_mKA9", tipo: "filme", genero: "Romance" },
...
function renderizar(lista) {
    ...
    generos.forEach(gen => {
        ...
        lista.filter(i => i.genero === gen).forEach(item => {
            ...
            card.className = 'card';
            card.innerHTML = `
                <img src="https://drive.google.com/thumbnail?id=${item.capaID}">
                <p>${item.titulo}</p>
            `;
